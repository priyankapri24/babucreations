...
const Chocolatebouquet = () => {
  ...
  const product = {
    ...
    description: 'A sweet surprise wrapped like love! This handcrafted chocolate bouquet features an elegant mix of Dairy Milk, KitKat, and more, beautifully wrapped with ribbons – perfect for birthdays, anniversaries, or just to make someone smile.',
    features: `• Includes popular chocolates like Dairy Milk, KitKat, 5 Star (customizable options available)
• Handcrafted with love in a bouquet-style design
...
🔔 Note: The exact number and size of chocolates may vary depending on your selection and availability.`,
...
• Thank you gesture or 'just because' surprise.`
    ...
    faqs: [
      {
        question: 'Is the chocolate bouquet customizable?',
        answer: 'Yes! You can customize the chocolate bouquet by selecting your preferred chocolates.',
      },
      {
        question: 'How long will the Chocolate Crown stay fresh?',
        answer: 'The chocolates stay good for 1–2 months if kept in a cool place.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Absolutely! Our chocolate bouquets make the perfect gift for birthdays, anniversaries, weddings, proposals, or any other special occasion. You can even add a special message to make it more personalized.',
      },
    ],
  };
