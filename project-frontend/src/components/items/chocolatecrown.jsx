...
const ChocolateCrown = () => {
  ...
  const product = {
    ...
    description: 'Make your celebrations royal and sweet with our beautiful Chocolate Crown! Crafted with delicious chocolates and arranged in a stunning crown shape, it’s the perfect gift for birthdays, anniversaries, or any special occasion. A sweet blend of creativity and taste, this crown will surely make your loved one feel special and cherished.',
...
• Elegant wrapping with premium sheets, mesh, and satin ribbons
...
• Thank you gesture or 'just because' surprise.`
    ...
    faqs: [
      {
        question: 'How big is the Chocolate Crown?',
        answer: 'The size may vary depending on the number of chocolates selected, but it is typically designed to fit as a decorative centerpiece or a gift.',
      },
      {
        question: 'Can I choose the chocolate types for the crown?',
        answer: 'Yes! You can customize the crown with your favorite chocolates. Just mention it while placing the order.',
      },
      {
      ...
      {
        question: 'Can I order the chocolate bouquet for a special occasion?',
        answer: 'Absolutely! Our chocolate crown make the perfect gift for birthdays, anniversaries, weddings, proposals, or any other special occasion. You can even add a special message to make it more personalized.',
      },
      {
      ...
      <div className="max-w-4xl mx-auto p-6 font-sans">
        ...
        <div className="space-y-4">
          ...
          <div className="mt-5">
            ...
            <div className="mt-6">
              <label className="block text-sm text-white mb-1 font-semibold">Select Chocolate</label>
              <select
                className="input-field p-3 w-full rounded-lg shadow-sm border border-purple-300 focus:ring-2 focus:ring-purple-600"
