...
const Sandlegarland = () => {
  ...
  const product = {
    ...
    description: 'Add a touch of tradition, purity, and elegance with our handcrafted Sandal Garland.Made using aromatic sandal-scented materials and carefully woven flowers, this garland is perfect for weddings, spiritual ceremonies, inaugurations, and special occasions. Its soothing fragrance and beautiful look bring blessings, positivity, and charm to every event.',
    features: `• Natural Sandal Fragrance for a calming and refreshing experience.
• : Easy to carry and gift without any damage
•  Approximate Length: 3 to 3.5 feet 
• Elegant and Traditional Design suitable for all ceremonies and functions.
•  Perfect for weddings, pujas, housewarmings, festivals, and spiritual events`,
    ...
    faqs: [
      {
        ...
        answer: 'Yes, we use natural sandalwood essence or fresh sandal materials to ensure an authentic and pleasant fragrance.',
      },
      {
      ...
      {
        question: 'Is the garland lightweight?',
        answer: 'rsonYes, our Sandal Garlands are designed to be lightweight and comfortable for wearing or decoration purposes.',
      },
      {
